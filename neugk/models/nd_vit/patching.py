"""Patching, merging and unpatching layers."""
...
class PatchMerge(nn.Module):
    ...
    def __init__(
        ...
        self.out_dim = int(c_multiplier * dim)
...
class PatchExpand(nn.Module):
    ...
    def __init__(
        ...
        dim_out = int(dim // c_multiplier) if out_channels is None else out_channels
