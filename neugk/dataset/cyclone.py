...
class CycloneDataset(Dataset):
    ...
    Args:
        ...
        partial_holdouts (optional, dict)
    ...
    def __init__(
        ...
        for f_id, f_path in enumerate(self.files):
            ...
            with h5py.File(f_path, "r") as f:
                ...
                if self.stats is not None and normalization_scope == "dataset":
                    # normalization stats
    ...
    def get_avg_flux(self, file_index: Union[int, Sequence[int]]):
        ...
        for f in file_index:
            ...
            fluxes = fluxes[-80:]  # NOTE: naive crop linear phase
